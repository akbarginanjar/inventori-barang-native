			...
			<div class="table-responsive">
				...
				<div class="body">
					...
					<form method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="form-line">
								<select hidden name="jenis_barang" value="<?php echo $tampil['jenis_barang']; ?>" class="form-control" />
						...
						<div class="form-group">
							<div class="form-line">
								<select name="satuan" value="<?php echo $tampil['satuan']; ?>" class="form-control" required />
					...
					if (isset($_POST['simpan'])) {
						...
						$sql = $koneksi->query("update gudang set kode_barang='$kode_barang', nama_barang='$nama_barang', satuan='$satuan' where kode_barang='$kode_barang'");
